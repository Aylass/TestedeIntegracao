...
public class Multiplicador {
    ...
    public Multiplicador vezes(Numero outro) {
        ...
        // se os sinais forem diferentes, o resultado era pra ser negativo, entao
    ...
    public Multiplicador dividido(Numero outro) {
        ...
        // divide
        // cria um count que conta quantas vezes podemos subtrair outro de resultado e o
        // armazena como resultado.
